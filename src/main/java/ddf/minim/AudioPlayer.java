...
public class AudioPlayer extends AudioSource implements Playable
{
	...
	public void loop()
	{
		recording.loop(Sound.LOOP_CONTINUOUSLY);
	}
    ...
    Sound.debug("AudioPlayer.skip: skipping " + millis + " milliseconds, new position is " + pos);
	...
	public AudioRecording getRecord() 
	{
		return recording;
	}
}
