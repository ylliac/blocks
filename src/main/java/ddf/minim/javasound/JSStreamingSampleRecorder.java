...
final class JSStreamingSampleRecorder implements SampleRecorder
{
  ...
  public AudioRecordingStream save()
  {
    ...
    {
      Sound.error("AudioRecorder.save: An error occurred when trying to save the file:\n"
                  + e.getMessage());
    }
  ...
  public void samples(float[] samp)
  {
    if ( recording )
    {
      ...
      {
        Sound.error("AudioRecorder: An error occurred while trying to write to the file:\n" +
                    e.getMessage() );
      }
    }
  }
